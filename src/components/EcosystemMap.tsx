...
const puzzlePieces = [
  {
    ...
    name: "AgenticID.Kred",
    title: "Identity",
    description: "Your Web3 identity — a human-readable name with on-chain memory.",
    icon: "🌐",
    accent: "180 60% 50%",
  },
  {
  ...
  },
  {
    ...
    title: "Sim Game",
    description: "Play and prove — economic simulation with 200K+ players.",
    icon: "💬",
    accent: "38 92% 60%",
  },
  {
    ...
    name: "Grab.Kred",
    title: "Instant Feeds",
    description: "Instant feeds — curated, AI-filtered blockchain activity.",
    icon: "⚡",
    accent: "50 90% 55%",
  },
  {
  ...
  },
  {
    ...
    name: "AgenticGiving",
    title: "Gift Studio",
    description: "Gift Studio mini App — specialized gifting experience for brands.",
    icon: "🎁",
    accent: "280 55% 55%",
  },
  {
    ...
    name: "NFT.NYC",
    title: "HUMANS ONLY",
    description: "The gathering — 8 events, 40K attendees. Live on stage.",
    icon: "🎤",
    accent: "210 60% 50%",
  },
];
